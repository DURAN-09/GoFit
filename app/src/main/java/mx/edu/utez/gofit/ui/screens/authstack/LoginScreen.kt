...
@Composable
fun LoginScreen( authState: AuthState, login: (String, String) -> Unit, onLoginSuccess: () -> Unit, onGoToRegister: () -> Unit){
    ...
    Column(
        ...
        Button(
            ...
            Text(if (authState.loading) "Cargando..." else "Iniciar sesión")
        }
